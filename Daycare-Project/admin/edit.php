...
session_start();
	...
	if (!isAdmin()) {
		...
		header('location: ../main.htm#login');
}


//Get ID from Database
if(isset($_GET['edit_id'])){
$query = "SELECT * FROM product WHERE code ='".$_GET['edit_id']."';";
...
$price = $_POST['price'];
$image = $_POST['image'];
$update = "UPDATE product SET image='$image', name='$name',price='$price' WHERE code='". $_GET['edit_id']."';";
...
<html>
	...
	<body>
		...
		<map id = "logomap" name="logomap">
			...
			<area shape="rect" coords="1055, 290, 1120, 332" href="../php/product.php" alt="product"/>
			<area shape="rect" coords="1155, 290, 1220, 332" href="../register.htm" alt="sign up"/>
			<area shape="rect" coords="1255, 290, 1300, 332" href="../php/cart.php" alt="sign up"/>
		</map>
	    <div class="bodyContent">
			<form method="POST">
				...
				<button type="submit" name="btn-update" id="btn-update" onClick="update()"><strong>Update</strong></button>
					<a href="editproduct.php"><button type="button" value="button">Cancel</button></a>
			</form>	
			<script>
				function update(){
				 var x;
		...
		<div class="footerPnl">
			<ul>
				...
				<li><a href="../php/product.php" target="window">Product</a></li>
				<li><a href="../register.htm" target="window">Sign Up</a></li>
				<li><a href="../php/cart.php" target="window">checkout</a></li>
			</ul>
		</div>
