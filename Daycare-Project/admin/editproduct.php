...
<html>
	...
	<body>
	    ...
	    <div class="bodyContent">
					...
					<table class="table">
						<caption style="color:red">Edit Products</caption>
			...
			while($row = mysqli_fetch_assoc($result)){?>
						<table class="table">
							...
							<tr>
								<td><img src='<?php echo $row['image']; ?>' width="50" height="40" /></td>
								<td  width="400"><?php echo $row['name'];?></td>
								<td><?php echo $row['price']; ?></td>
								<td>
									<form method='post' action='edit.php?edit_id=<?php echo $row['code'];?>'>
										<button type='submit' class='remove'>Edit Item</button>
									</form>
								</td>
							</tr>
					</table>
